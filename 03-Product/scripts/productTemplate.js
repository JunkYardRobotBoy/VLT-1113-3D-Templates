...
const modelFile = 'CoffeeCupRS.glb'                              // 3D model to spawn at tap
const startScale = new BABYLON.Vector3(0.01, 0.01, 0.01)  // Initial scale value for our model
const endScale = new BABYLON.Vector3(0.2, 0.2, 0.2)    // Ending scale value for our model
...
const placeObjectTouchHandler = (e) => {
  ...
  if (pickResult.hit && pickResult.pickedMesh == surface) {
    ...
    const gltf = BABYLON.SceneLoader.LoadAssetContainer("assets/", "CoffeeCupRS.glb", scene,
